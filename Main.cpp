			...
			try{
				...
				if(choice==1)
				{
					...
					for(int i = noOfRooms; i < noOfRooms+ch; i ++) 
					{
							...
							cout<<"Is the Room Number "<<r<<" empty(Press 1 for empty, 0 for booked)? ";
							cin>>e;
					...
					for (j=0;j<ch;j++)
					{
						...
						while(cin>>gen)
						{
							if(gen=='M' || gen=='F')
							{
								...
								cout<<"Only M/F can be entered.Please Re-enter."<<endl;
						}
						...
						while(1)
						{
							...
							while(num!=0)
							{
								...
								{
									cout<<"ID must have 4 digits only.Please Re-enter."<<endl;
									cin>>id;
								}
						}
				...
				else if(choice==3)
				{
					cout<<"--------------------------------------------------DATA ENTRY OF CUSTOMER--------------------------------------------------"<<endl;
						...
						cout<<"Enter the ID (Only 4 Digits): "<<endl;
						cin>>id;
						while(1)
						{
							int num=id,count=0;
